...
Winery.create(name: "V. Sattui Winery", location: "Napa")
Winery.create(name: "Darioush Winery", location: "Oak Knoll")
Winery.create(name: "Castello di Amorosa", location: "Calistogo")
Winery.create(name: "Spottswoode", location: "St. Helena")
Winery.create(name: "Inglenook Winery", location: "Rutherford")
Winery.create(name: "Artesa Vineyards & Winery", location: "Napa")
Winery.create(name: "Mondavi", location: "Napa")
